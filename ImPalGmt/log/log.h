...
public:
	...
	void WriteLog(const char* function, const char* format, Args... args)
	{
		if (!hLogFile && isFile_)
		{
			...
			sprintf_s(strLogFilePath, MAX_PATH, "./logs/%04d-%02d-%02dT%02d-%02d-%02d_out.log", tmNow.tm_year + 1900, tmNow.tm_mon + 1, tmNow.tm_mday, tmNow.tm_hour, tmNow.tm_min, tmNow.tm_sec);
